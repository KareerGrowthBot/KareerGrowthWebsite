...
import { ChevronLeft, Star, Quote, Trophy, TrendingUp, ArrowRight } from 'lucide-react';
import { carouselStories } from '../data/storiesData';

const StoryDetail = () => {
    const { id } = useParams();
    const navigate = useNavigate();
    const story = carouselStories.find(s => s.id === id);
    ...
    if (!story) {
        return (
            <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 text-center">
                ...
                <h1 className="text-2xl md:text-4xl font-bold mb-4">Success Story Not Found</h1>
                <p className="text-zinc-500 mb-8 max-w-sm text-sm">We couldn't find the specific story you're looking for. It might have been moved or renamed.</p>
                <button
        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative h-[50vh] md:h-[70vh] overflow-hidden flex flex-col">
                <div className="absolute inset-0 z-0">
                    <img src={story.image} alt="" className="w-full h-full object-cover opacity-40 scale-105" />
